...
void Tree::test(){
	...
	point p0(33.1746,-87.5251);point p(33.1672,-87.5151);point p1(33.189,-87.3251);
	point q0(33.5367,-88.4374);point q(33.208,-87.5711); point q1(33.2048,-87.5674);


	int chck_q0 = rightTurn(p,q,q0);
	int	chck_q1 = rightTurn(p,q,q1);
	int chck_p0 = rightTurn(q,p,p0);
	int chck_p1 = rightTurn(q,p,p1);


//	int	chck_q1 = rightTurn(p,q,q1);
	cout<<  (1.2-1.45)*(2.2-3.61) -(3-3.61)*(0.9-1.45)<<endl;

	cout<<chck_q0<<chck_q1<<chck_p0<<chck_p1;
...
int Tree::rightTurn(const point &p1, const point &p2, const point &p3) const
{
	...
	//cout<<"test"<<std::setprecision(15)<<abs(cross_prod)<<endl;
...
//
//
//		if ( abs(cross_prod) < 1e-18 )
//			return 2; //no turn (colinear points)
//		else if ( cross_prod < 1e-17 )
//			return 0;  // turn left
//		else
//			return 1;  //turn right
...
//	}
	...
	if(   (chck_p1==1||chck_p1==2) && (chck_p0==1 || chck_p0==2) && (chck_q1==0 || chck_q1==2) && (chck_q0==0 || chck_q0==2 ))
		return 1;
	else if( (chck_p1==1||chck_p1==2) && (chck_p0==1 || chck_p0==2) && (chck_q1==0 || chck_q1==2))
		return 2;
	else if((chck_p1==1||chck_p1==2) && (chck_p0==1 || chck_p0==2) && (chck_q0==0 || chck_q0==2 ))
		return 3;
	else if((chck_p0==1||chck_p0==2)  && (chck_q1==0 || chck_q1==2) && (chck_q0==0 || chck_q0==2 ))
		return 4;
	else if((chck_p1==1||chck_p1==2) &&  (chck_q1==0 || chck_q1==2) && (chck_q0==0 || chck_q0==2 ))
		return 5;
	else if ( (chck_p0==1 || chck_p0==2) && (chck_q1==0 || chck_q1==2))
		return 6;
	else if ( (chck_p1==1||chck_p1==2)&& (chck_q1==0 || chck_q1==2) )
	    return 7;
	else if ( (chck_p0==1 || chck_p0==2)  && (chck_q0==0 || chck_q0==2 ))
		return 8;
	else if( (chck_p1==1||chck_p1==2) && (chck_q0==0 || chck_q0==2 ))
	{
		intersec = case9(p,p0,p1,q,q0,q1,flag_lh,flag_uh);
		if (intersec < half)
			 return 9;
...
//		return 1;
//
//	else if (chck_p0==2 && chck_p1==0 && chck_q1==0 && chck_q0==2)
//		return 1;
...
//	}
	...
	if(   (chck_p1==0||chck_p1==2) && (chck_p0==0 || chck_p0==2) && (chck_q1==1 || chck_q1==2) && (chck_q0==1 || chck_q0==2 ))
		return 1;
	else if( (chck_p1==0||chck_p1==2) && (chck_p0==0 || chck_p0==2) && (chck_q1==1 || chck_q1==2))
		return 2;
	else if((chck_p1==0||chck_p1==2) && (chck_p0==0 || chck_p0==2) && (chck_q0==1 || chck_q0==2 ))
		return 3;
	else if((chck_p0==0||chck_p0==2)  && (chck_q1==1 || chck_q1==2) && (chck_q0==1 || chck_q0==2 ))
		return 4;
	else if((chck_p1==0||chck_p1==2) &&  (chck_q1==1 || chck_q1==2) && (chck_q0==1 || chck_q0==2 ))
		return 5;
	else if ( (chck_p0==0 || chck_p0==2) && (chck_q1==1 || chck_q1==2))
		return 6;
	else if ( (chck_p1==0||chck_p1==2)&& (chck_q1==1 || chck_q1==2) )
	    return 7;
	else if ( (chck_p0==0 || chck_p0==2)  && (chck_q0==1 || chck_q0==2 ))
		return 8;
	else if( (chck_p1==0||chck_p1==2) && (chck_q0==1 || chck_q0==2 ))
	{
		intersec = case9(p,p0,p1,q,q0,q1,flag_lh,flag_uh);
		if (intersec < half)
			 return 9;
...
double Tree::cross(const point &O, const point &A, const point &B) {
...
vector<point> Tree::convex_hull(vector<point> P) {
	int n = P.size(), k = 0;
	if (n == 1)
		return P;
	vector<point> H(2 * n);
...
void Tree::addQueuePointsToSet(vector<point> &v, node *current_node) {
	if (current_node != NULL) {
		...
		addQueuePointsToSet(v, current_node->right);

		addQueuePointsToSet(v, current_node->middle);

		addQueuePointsToSet(v, current_node->left);
...
double Tree::xmulti(point p1, point p2, point p0) {
...
bool Tree::isInConvex(vector<point> &vec, point p0) {
